...
def run():
    ...
    if not sql_times_delete_simple or not mongo_times_delete_simple:
        print("No se pudieron obtener los tiempos de eliminación simple para MySQL o MongoDB.")
        return
    graficar_comparativa(sql_times_delete_simple, mongo_times_delete_simple, "MySQL Delete Simple", "MongoDB Delete Simple", "Comparativa de Eliminación Simple")